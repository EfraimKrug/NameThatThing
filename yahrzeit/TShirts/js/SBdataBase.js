...
function formatOrder(accountID,targetID,shirtID,size,number,price,flag){
  var str = "accountID=" + accountID + "&targetID=" + targetID + "&shirtID=" + shirtID.replace("#","") + "&size=" + size + "&number=" + number + "&price=" + price + "&flag=" + flag;
  return str;
}
