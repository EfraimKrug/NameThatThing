...
$paidFlag = 0;
$sql = "INSERT INTO `SBOrders` (`accountID`,`targetID`,`shirtID`,`size`,`Number`,`price`,`paidFlag`,`orderDate`,`sentDate`) VALUES ('" . $accountID .  "','" . $targetID .  "','"  . $shirtID . "','" . $size . "'," . $Number . "," . $price . "," . $paidFlag . ",'" . $today . "','0000-00-00')";
// echo $sql;
